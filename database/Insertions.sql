...
VALUES
-- Animaux
('A quoi ressemble un chien ?','facile',1),
('A quoi ressemble un chat?','facile',1),
('A quoi ressemble un ours ?','facile',1),
('A quoi ressemble un lapin ?','facile',1),
('A quoi ressemble un poisson?','facile',1),
